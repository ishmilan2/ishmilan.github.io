...
JUnit plugin is the responsible to show the results of executed tests in the project. XCode plugin generate an XML file into the folder `test-reports` located in the root of project.
